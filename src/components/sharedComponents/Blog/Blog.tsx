...
const Blog: React.FC<blogProps> = (props) => {
    const { blog: {id, title, content, categories, date, readMore }, deleteBlog} = props;
    ...
    <div id={id} className="blog">
        ...
        <div className="blog_details">
           <div className="blog_detail_header">
               <Link to={`/viewBlog/${id}`}><SectionHeader header={title} /></Link>
               <Button id="blog_delete_button" className="blog_delete_button" icon="trash" onClick={deleteBlogById} /> </div>
